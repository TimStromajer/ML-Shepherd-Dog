...
public class GameManager : MonoBehaviour
{
    ...
    // spawn boundaries
    private float minSpawnX = -10.0f;
    private float maxSpawnX = 10.0f;
    private float minSpawnZ = -10.0f;
...
public class Strombom
{
    ...
    public float c = 1.05f; // attraction to n nearest neighbours
